...
public class MainTest {
    ...
    @Test
    public void should_return_player1_win_when_both_flush_but_player1_has_bigger_poker() {
        // given
        List<String> pokers = Arrays.asList("2C", "9C", "7C", "JC", "AC", "5S", "TS", "AS", "3S", "9S");
        // when
        String result = new Main().playingPokers(pokers);
        // then
        Assert.assertEquals("player1 win", result);
    ...
    @Test
    public void should_return_player2_win_when_both_have_full_house_but_player2_has_bigger_one() {
        // given
        List<String> pokers = Arrays.asList("2C", "2H", "2S", "JC", "JD", "5S", "5D", "5C", "9D", "9S");
        // when
        String result = new Main().playingPokers(pokers);
        // then
        Assert.assertEquals("player2 win", result);
    ...
    @Test
    public void should_return_player1_win_when_he_has_four_of_a_kind_but_player2_have_full_house() {
        // given
        List<String> pokers = Arrays.asList("2C", "2H", "2S", "2D", "JD", "5S", "5D", "5C", "9D", "9S");
        // when
        String result = new Main().playingPokers(pokers);
        // then
        Assert.assertEquals("player1 win", result);
    ...
    @Test
    public void should_return_player2_win_when_both_have_four_of_a_kind_but_player2_has_bigger_one() {
        // given
        List<String> pokers = Arrays.asList("2C", "2H", "2S", "2D", "JD", "5S", "5D", "5C", "5H", "9S");
        // when
        String result = new Main().playingPokers(pokers);
        // then
        Assert.assertEquals("player2 win", result);
